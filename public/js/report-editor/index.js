...
var EditorComponent = (_class = function (_React$Component) {
  ...
  _createClass(EditorComponent, [{
    ...
    value: function componentDidMount() {
      ...
      this.cm.on('change', function (e) {
        return _this2.props.onChange(e.doc.getValue());
      });
    ...
    value: function render() {
      return React.createElement(
        "div",
        { "class": "cm-wrapper", onClick: this.focus },
        React.createElement("textarea", { id: this.state.elementId, placeholder: this.props.placeholder, value: this.state.markdown }),
        React.createElement("div", { className: "cm-line" })
      );
    }
  }]);

  return EditorComponent;
}(React.Component), (_applyDecoratedDescriptor(_class.prototype, "focus", [_decko.bind], Object.getOwnPropertyDescriptor(_class.prototype, "focus"), _class.prototype)), _class);
exports.default = EditorComponent;

},{"codemirror":16,"codemirror/addon/display/placeholder.js":14,"codemirror/addon/mode/overlay.js":15,"codemirror/mode/clike/clike.js":17,"codemirror/mode/css/css.js":18,"codemirror/mode/gfm/gfm.js":19,"codemirror/mode/htmlmixed/htmlmixed.js":20,"codemirror/mode/javascript/javascript.js":21,"codemirror/mode/markdown/markdown.js":22,"codemirror/mode/meta.js":23,"codemirror/mode/xml/xml.js":24,"decko":26}],5:[function(require,module,exports){
"use strict";
...
var _takeInParams = require('../utils/take-in-params');

var _section = require('./section');

var _section2 = _interopRequireDefault(_section);

var _normalizeParams = require('../utils/normalize-params');
...
var Report = (0, _takeInParams.mixinTakeInParams)(_class = function Report() {
  ...
  var _toCamel = (0, _normalizeParams.toCamel)(params);
...
},{"../utils/normalize-params":10,"../utils/take-in-params":11,"./section":9}],9:[function(require,module,exports){
'use strict';
...
},{"../utils/normalize-params":10,"../utils/take-in-params":11}],10:[function(require,module,exports){
'use strict';
...
function toCamel(params) {
  var normalized = {};
  for (var i in params) {
    normalized[(0, _changeCase.camelCase)(i)] = params[i];
  }
  return normalized;
}

function toSnake(params) {
  var normalized = {};
  for (var i in params) {
    normalized[(0, _changeCase.snakeCase)(i)] = params[i];
  }
  return normalized;
}

},{"change-case":13}],11:[function(require,module,exports){
"use strict";
...
},{"no-case":34,"upper-case":46}],13:[function(require,module,exports){
...
},{"camel-case":12,"constant-case":25,"dot-case":27,"header-case":28,"is-lower-case":29,"is-upper-case":30,"lower-case":32,"lower-case-first":31,"no-case":34,"param-case":38,"pascal-case":39,"path-case":40,"sentence-case":41,"snake-case":42,"swap-case":43,"title-case":44,"upper-case":46,"upper-case-first":45}],14:[function(require,module,exports){
...
},{"../../addon/mode/overlay":15,"../../lib/codemirror":16,"../markdown/markdown":22}],20:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":16,"../css/css":18,"../javascript/javascript":21,"../xml/xml":24}],21:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":16}],22:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":16,"../meta":23,"../xml/xml":24}],23:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../lib/codemirror":16}],24:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
},{"../../lib/codemirror":16}],25:[function(require,module,exports){
var upperCase = require('upper-case')
...
},{"snake-case":42,"upper-case":46}],26:[function(require,module,exports){
...
},{"no-case":34}],28:[function(require,module,exports){
var noCase = require('no-case')
var upperCase = require('upper-case')
...
},{"no-case":34,"upper-case":46}],29:[function(require,module,exports){
...
},{"lower-case":32}],30:[function(require,module,exports){
var upperCase = require('upper-case')
...
},{"upper-case":46}],31:[function(require,module,exports){
var lowerCase = require('lower-case')
...
},{"lower-case":32}],32:[function(require,module,exports){
/**
...
},{"./vendor/camel-case-regexp":35,"./vendor/camel-case-upper-regexp":36,"./vendor/non-word-regexp":37,"lower-case":32}],35:[function(require,module,exports){
...
},{"no-case":34}],39:[function(require,module,exports){
...
},{"camel-case":12,"upper-case-first":45}],40:[function(require,module,exports){
var noCase = require('no-case')
...
},{"no-case":34}],41:[function(require,module,exports){
var noCase = require('no-case')
var upperCaseFirst = require('upper-case-first')
...
},{"no-case":34,"upper-case-first":45}],42:[function(require,module,exports){
var noCase = require('no-case')
...
},{"no-case":34}],43:[function(require,module,exports){
var upperCase = require('upper-case')
var lowerCase = require('lower-case')
...
},{"lower-case":32,"upper-case":46}],44:[function(require,module,exports){
var noCase = require('no-case')
var upperCase = require('upper-case')
...
},{"no-case":34,"upper-case":46}],45:[function(require,module,exports){
var upperCase = require('upper-case')
...
},{"upper-case":46}],46:[function(require,module,exports){
/**
 * Special language-specific overrides.
 *
 * Source: ftp://ftp.unicode.org/Public/UCD/latest/ucd/SpecialCasing.txt
...
var _editor = require('./lib/components/editor');
...
var ReportEditor = (0, _hub.receiver)(_class2 = (0, _hub.sender)(_class2 = (_class3 = function (_React$Component) {
  ...
  _createClass(ReportEditor, [{
    ...
    get: function get() {
      ...
      return this.isPersisted ? React.createElement(
        'button',
...
var ReportSectionEditor = (0, _hub.sender)(_class4 = (_class5 = function (_React$Component2) {
  ...
  _createClass(ReportSectionEditor, [{
    ...
    key: 'changeRaw',
    value: function changeRaw(value) {
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          'label',
          null,
          React.createElement('input', { type: 'checkbox', onChange: this.toggleMode }),
          'preview'
        ),
        React.createElement(
          'div',
          { className: 'report-edit-and-preview' },
          this.content
        )
      );
    }
    ...
    get: function get() {
      ...
      return this.state.isPreview ? React.createElement('section', { 'class': 'preview', dangerouslySetInnerHTML: { __html: (0, _marked2.default)(raw) } }) : React.createElement(_editor2.default, _extends({ markdown: raw }, { onChange: this.changeRaw }));
    }
  }]);

  return ReportSectionEditor;
}(React.Component), (_applyDecoratedDescriptor(_class5.prototype, 'changeRaw', [_decko.bind], Object.getOwnPropertyDescriptor(_class5.prototype, 'changeRaw'), _class5.prototype), _applyDecoratedDescriptor(_class5.prototype, 'toggleMode', [_decko.bind], Object.getOwnPropertyDescriptor(_class5.prototype, 'toggleMode'), _class5.prototype)), _class5)) || _class4;

},{"./lib//api":2,"./lib//api-configuration/report":1,"./lib//components/fa":5,"./lib/components/editor":4,"./lib/hub":6,"./lib/models/condition":7,"./lib/models/report":8,"decko":26,"marked":33}]},{},[47]);
