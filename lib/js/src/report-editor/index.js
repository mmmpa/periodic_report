...
class ReportEditor extends React.Component {
  ...
  submit () {
    ...
    let { reportId, reportGroupId, sections } = this.state
    this.sendTargetAPI({ reportId, reportGroupId, sections })
      .then((params) => {
  ...
  updateReport () {
    ...
    let { reportId, reportGroupId, name, items } = this.state
    API.updateReport({ reportId, reportGroupId, name, items })
      .then((params) => {
        this.takeInState(params)
        this.setState({ condition: Condition.Waiting })
      })
